...
<?php endif ; ?>
<!-- News Offers Carousel -->
<?php $values = get_field( 'email' ); ?>
<?php if ($values) : ?>
<section class="business-enquiry" id="business-enquiry">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="sign-up">
					<form method="POST" action="#business-enquiry" id="">
						Fill in your <span> <input placeholder="name" id="name" name="name" type="text" /></span>, your <span> <input placeholder="email address" id="email-address" name="email-address" type="text" /></span> and your <span> <input placeholder="enquiry" id="enquiry" name="enquiry" type="text" /></span>and someone will be in touch!<br>
						<button class="submit-btn" type="submit" name="send-place-email">send enquiry now</button>
					</form>
					<?php $companyemail = get_field('email');   ?>
					<?php if (isset($_POST['send-place-email'])):  ?>
					<?php
					...
					$body = "New Enquiry from: $name, <br> Email Address: $email, <br> Message: $enquiry";
					$headers = array('Content-Type: text/html; charset=UTF-8');
					if(empty($name) || empty($email) || empty($enquiry)) {
					    echo "Complete the missing fields.";
					} else {
					wp_mail( $to, $subject, $body, $headers );
					echo "Thanks for your email, someone will be in touch shortly.";
					}
					?>
					<?php endif; ?>
					<?php // print_r($_POST); ?>
...
<img class="clip-white-bottom-alt-two " src="<?php echo get_template_directory_uri(); ?>/images/slants/white-bottom.png" class="img-responsive" alt="">
<?php endif; ?>
<!-- Testing -->
<!-- Testing -->
<!-- Map -->
