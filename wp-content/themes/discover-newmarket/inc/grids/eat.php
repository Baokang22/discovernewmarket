...
<img class="clip-grey " src="<?php echo get_template_directory_uri(); ?>/images/slants/footer-top.png" class="img-responsive" alt="top">
<section class="things-to-do ">
    <div class="container container-color">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="filters">
                    <?php $terms = get_terms( 'category', 'child_of=9' );
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="content" class="to-do-grid">
                    ...
                    <?php $category_todo = wp_get_post_terms($post->ID, 'category', 'child_of=9', array("fields" => "eat")); ?>
...
<img class="clip-grey-bottom " src="<?php echo get_template_directory_uri(); ?>/images/slants/grey-bottom.png" class="img-responsive" alt="bottom">
<script>
