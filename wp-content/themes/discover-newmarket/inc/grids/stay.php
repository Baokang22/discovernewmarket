...
<section class="things-to-do ">
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="filters">
                    <?php $terms = get_terms( 'category', 'child_of=7' );
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="content" class="to-do-grid">
                    ...
                    <?php $category_todo = wp_get_post_terms($post->ID, 'category', 'child_of=7', array("fields" => "stay")); ?>
                    <div class="to-do-box <?php foreach($category_todo as $category) { echo $category->slug . '  '; }; ?>"  data-match-height="true">
                        <div class="icon">
                        <?php /* 
                            <img src="<?php echo get_template_directory_uri(); ?>/images/png/Stay-icon.png" class="img-responsive" alt="Stay" />
                            */ ?>
                        </div>
                        <div class="image">
            ...
            <div class="to-do-grid-mobile hidden-md hidden-lg">
                ...
                $myposts = get_posts( $args );
                foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
                <?php $category_todo = wp_get_post_terms($post->ID, 'category', 'child_of=7', array("fields" => "all")); ?>
                <div class="to-do-box <?php foreach($category_todo as $category) { echo $category->slug . '  '; }; ?>"  data-match-height="true">
                    <div class="icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/png/Stay-icon.png" class="img-responsive" alt="Eat" />
                    </div>
                    <div class="image">
                        <?php if ( has_post_thumbnail() ) : ?>
                            <a href="<?php the_permalink(); ?>">
...
<?php get_template_part( 'inc/ajax-loader/stay-loader/ajax-action'); ?>