...
<section class="things-to-do ">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="button-group button-filter filter-button-group">
                    <button data-filter=".month-01">January</button>
                    <button data-filter=".month-02">Febuary</button>
                    <button data-filter=".month-03">March</button>
                    <button data-filter=".month-04">April</button>
                    <button data-filter=".month-05">May</button>
                    <button data-filter=".month-06">June</button>
                    <button data-filter=".month-07">July</button>
                    <button data-filter=".month-08">August</button>
                    <button data-filter=".month-09">September</button>
                    <button data-filter=".month-10">October</button>
                    <button data-filter=".month-11">November</button>
                    <button data-filter=".month-12">December</button>
