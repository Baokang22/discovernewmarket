<?php
add_action('wp_ajax_nopriv_business_loader_ajax', 'business_loader_ajax');
add_action('wp_ajax_business_loader_ajax', 'business_loader_ajax');

function business_loader_ajax(){
    $offset = $_POST["offset"];
    $ppp = $_POST["ppp"];
